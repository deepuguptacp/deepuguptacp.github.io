      ...
      >
        ...
        <div className="grid md:grid-cols-2 gap-8">
          <div className="bg-white dark:bg-gray-800 p-6 rounded-lg shadow-lg">
            <h2 className="text-2xl font-semibold text-blue-600 dark:text-blue-400 mb-4">Get in Touch</h2>
            ...
            <div className="space-y-4">
              ...
              <div className="flex items-center space-x-3">
                ...
                <span className="text-gray-700 dark:text-gray-300" style={{ width: '100px' }}>
                  {showPhone ? '7050102744' : '**********'}
                </span>
                <button onClick={() => setShowPhone(!showPhone)} className="text-blue-600">
